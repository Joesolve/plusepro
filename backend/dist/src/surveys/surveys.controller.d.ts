...
export declare class SurveysController {
    ...
    assign(id: string, tenantId: string, userIds: string[]): Promise<import(".prisma/client").Prisma.BatchPayload>;
    respond(id: string, tenantId: string, userId: string, answers: any[]): Promise<{
        answers: {
            id: string;
            createdAt: Date;
    ...
    getResponses(id: string, tenantId: string): Promise<({
        answers: ({
            question: {
                id: string;
                createdAt: Date;
    ...
    getCompletionRate(id: string, tenantId: string): Promise<{
        total: number;
        completed: number;
        rate: number;
    }>;
