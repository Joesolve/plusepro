...
exports.SurveysModule = SurveysModule = __decorate([
    (0, common_1.Module)({ controllers: [surveys_controller_1.SurveysController], providers: [surveys_service_1.SurveysService], exports: [surveys_service_1.SurveysService] })
], SurveysModule);
